//抽奖总人数
var count= window.prompt("请输入本次活动参与人数",150);
var allPersonNumber = count?count:150;
//抽奖人员名单
var allPerson = getAllPerson(allPersonNumber);
//领导人员名单
var leaderArr = [];
//未中奖人员名单
...
function getAllPerson(allPersonNumber){
    var str='',arr=[];
    for(i=1;i<=allPersonNumber;i++){
        arr.push(i);
    }
    str =arr.join(';');
    return str;
